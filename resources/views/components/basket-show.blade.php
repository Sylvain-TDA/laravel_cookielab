        ...
        <div class="row">
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <div class="card-body">
                        {{-- <div> <img src="{{$temporary_basket['url_image']}}" alt="cookie {{$temporary_basket['name']}}"
                                style="height:100px; width: auto;">
                        </div>
                        <h5 class="card-title">{{ $temporary_basket['name'] }}</h5>
                        <p class="card-text">{{ Str::limit($temporary_basket['description'], 100) }}</p>
                        <p class="card-text">
                            <strong class="">{{ number_format($temporary_basket['sum'], 2) }}€</strong>
                        </p> --}}
                        <div> @if(session()->has('temporary_basket'))
                            <ul>
                                @foreach(session('temporary_basket') as $cookie)
                                    <li>{{ $cookie['name'] }} - {{ $cookie['sum'] }}€</li>
                                @endforeach
                            </ul>
                        @endif
                        </div>
                        ...
                        <div class="col-10">
                            ...
                            <div class="card rounded-3 mb-4">
                                <div class="card-body p-4">
                                    <div class="row d-flex justify-content-between align-items-center">
                                        <div class="col-md-2 col-lg-2 col-xl-2">
                                            <img src="{{ asset('images/kit.png') }}" class="img-fluid rounded-3"
                                                alt="Kit cookies">
                                        </div>
                                        <div class="col-md-3 col-lg-3 col-xl-3">
                                            <p class="lead fw-normal mb-2">Kit cookies prix</p>
