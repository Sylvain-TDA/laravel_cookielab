            ...
            @foreach($order_items as $order_item)
                <div class="col-md-4 mb-4">
                    <div class="card h-100">
                        <div class="card-body">
                            <div> <img src="{{ $order_item->product->url_image }}" alt="cookie {{$order_item->product->name}}"
                                    style="height:100px; width: auto;">
                            </div>
                            <h5 class="card-title">{{ $order_item->product->name }}</h5>
                            <p class="card-text">{{ Str::limit($order_item->product->description, 100) }}</p>
                            <p class="card-text">
                                <strong class="">{{ number_format($order_item->product->price, 2) }}€</strong>
                            </p>
                        </div>
                        <div class="card-footer">
                            <a href="{{ route('backoffice.product-show', $order_item->product->id) }}" class="btn text-light"
